...
{
    /// <summary>
    /// Вспомогательные статьи по Стрибогу:<br/>
    /// 1. <a href="https://habr.com/ru/articles/188152/">https://habr.com/ru/articles/188152/</a><br/>
    /// 2. <a href="https://vlsergey.github.io/infosec/8_4_Hesh_funktsija_Stribog_.html">https://vlsergey.github.io/infosec/8_4_Hesh_funktsija_Stribog_.html</a>
    /// </summary>
    class Streebog
    {
        ...
        /// <summary>
        /// Вектор Тау (используется для P-преобразования).<br />
        /// Также известен как SBox.
        /// </summary>
        ...
        {
            byte[] c = new byte[64];
            for (int i = 0; i < 64; i++) c[i] = (byte)(a[i] ^ b[i]);
            return c;
        }
